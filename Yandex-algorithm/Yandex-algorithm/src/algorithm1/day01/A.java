...
public class A {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getTemperatureInHour(troom, tcond, mode));
    }

    public static int getTemperatureInHour(int troom, int tcond, String mode) {

        return switch (mode) {
            case "freeze" -> Integer.min(troom, tcond);
            case "heat" -> Integer.max(troom, tcond);
            case "auto" -> tcond;
            case "fan" -> troom;
            default -> -1; // ex
        };
